                    ...
                    >
                      <div className="inline-flex md:hidden mb-4">
                        <div className="relative bg-primary text-white text-[10px] font-bold px-5 py-2.5 rounded-sm shadow-md uppercase tracking-wide">
                          {exp.year}
                          <div className="absolute bottom-3 -left-1 w-3 h-3 bg-primary rotate-45"></div>
                        </div>
                      </div>
                      ...
                      <h3 className="text-xs lg:text-[14px] font-bold uppercase text-[#334155] mb-2 tracking-widest">
                        {exp.place}
                      </h3>
                      ...
                      {exp.desc2 && (
                        <p className="text-gray-500 text-[10px] lg:text-[12px] leading-relaxed italic mt-1">
