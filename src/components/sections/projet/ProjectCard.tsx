...
const ProjectCard: React.FC<{ project: Project }> = ({ project }) => {
  return (
    <div
      ...
      className="bg-[#F3F4F6] border  border-blue-300 rounded-2xl p-4 hover:border-blue-600 transition-all duration-300 group"
    >
  ...
  <p className="text-gray-500 text-sm min-h-26 line-clamp-3 mb-4 leading-relaxed">
    {project.description}
  </p>
