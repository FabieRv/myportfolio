        ...
        <div className="relative flex flex-row justify-between gap-4">
                ...
                {testimonials.map((testimonial, index) => (
                  ...
                  >
                    <img
                      ...
                      width={800}
                      draggable={false}
                      className="h-auto w-full  rounded-3xl  object-cover object-center  border-2 border-amber-500 p2"
                    />
                  </motion.div>
                ))}
              </AnimatePresence>
          ...
          <div className="flex justify-between flex-col py-4">
            ...
            <div className="flex gap-4 pt-12 md:pt-0">
              <button
                onClick={handlePrev}
                className="h-7 w-7 rounded-full bg-button flex items-center justify-center group/button text-white"
              >
